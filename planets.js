...
console.log(solarSystem.push({name:"Pluto", ringSystem: true, moons: ["Charon"] }))
...
console.log(solarSystem[2].diameter= "7,926.2mi")
...
console.log(solarSystem[6].moons.pop());
console.log(solarSystem[6].moons.push("Oberon"));
